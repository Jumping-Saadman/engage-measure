...
writer = csv.writer(f)
header = ['Time in seconds', 'Screen Sharing', 'Hasib joined', 'Soha joined', 'Date', 'Time']
...
while True:
    ...
    writer.writerow([current_time, contcnt>100, hasib_joined, soha_joined, date, time])
